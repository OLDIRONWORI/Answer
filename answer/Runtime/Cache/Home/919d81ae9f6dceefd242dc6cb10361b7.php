...
<head>
    ...
    <!--/working/Answer/Public-->
    <!-- Bootstrap Core CSS -->
    <link href="/working/Answer/Public/css/bootstrap.min.css" rel="stylesheet" type="text/css">

    <!-- MetisMenu CSS -->
    <link href="/working/Answer/Public/css/metisMenu.min.css" rel="stylesheet" type="text/css">

    <!-- Custom CSS -->
    <link href="/working/Answer/Public/css/sb-admin-2.css" rel="stylesheet" type="text/css">
...
<script src="/working/Answer/Public/js/jquery-1.11.0.js"></script>
